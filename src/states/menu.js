class Menu extends Phaser.State {
  ...
  create() {
    ...
    this.ready = this.game.add.sprite(this.game.world.centerX,350,'text_ready');
    this.ready.anchor.set(0.5,0.5);
    this.ready.visible=false;
    this.go = this.game.add.sprite(this.game.world.centerX,350,'text_go');
    this.go.anchor.set(0.5,0.5);
    this.go.visible =false;

    //add intro text
    this.menuText = this.add.text(this.game.world.centerX,400, 'Click to enjoy life', {
